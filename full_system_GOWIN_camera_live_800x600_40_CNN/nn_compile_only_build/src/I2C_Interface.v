...
module I2C_Interface #(parameter SID = 8'h42) ( 
    ...
    always @ (posedge clk) begin
        ...
        // Implement two-write data transmission of SCCB protocol
            ...
            case ({busy_sr[31:28],busy_sr[2:0]})        // Checking for the start and stop condition
                // For START condition
                7'b1111_111: begin                       // bit 31th of data_sr is transmitted, SIOC must be high
                ...
                7'b1111_110: begin                       // bit 30th of data_sr is transmitted
                ...
                7'b1111_100: begin                       // bit 29th of data_sr is transmitted (don't care bit)
                ...
                // For STOP condition
                7'b1110_000: begin                       // bit 2nd of data_sr is transmitted (don't care bit)
                ...
                7'b1100_000: begin                       // bit 1st of data_sr is transmitted
                ...
                7'b1000_000: begin                       // bit 0th of data_sr is transmitted
