...
if (SIMULATION != 0) begin : g_sim
    ...
    assign video_pixel_x = x_cnt;
    assign video_pixel_y = y_cnt;
    assign video_rgb565 = video_rgb565_r;
    assign {video_pixel_valid_r, video_rgb565_r} = video_stream_pipe;
